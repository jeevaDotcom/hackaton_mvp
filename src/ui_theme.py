...
[data-testid="stExpander"] { border: 0; border-radius: var(--radius-sm); background: var(--surface); }
...
div[data-testid="stDownloadButton"] > button:hover, div.stButton > button:hover { background: var(--accent-hover); color: white; }
