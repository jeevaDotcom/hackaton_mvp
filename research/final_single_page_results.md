...
1. **Application URL:** `http://localhost:8501` after `streamlit run app.py`.
...
13. **Screenshots:** PASS — 13 single-page captures are stored in `submission/screenshots/`, alongside the retained historical and live-workflow captures.
14. **Automated tests:** PASS — `97 passed` on the final crash-safe rerun.
